...
9. [`ACTIVATION-OPERATIONAL-READINESS-AND-SAFETY-GATE.md`](ACTIVATION-OPERATIONAL-READINESS-AND-SAFETY-GATE.md) لتحديد دعم وحوادث وإطلاق تدريجي وإتاحة وقياس Pilot بحدود صادقة؛ لا يختار مزودًا أو SLA أو قانونًا أو يصرح بتنفيذ A/B.
