...
هذه المكتبة هي فهرس عملي للمراجع التي يجوز الرجوع إليها أثناء تطوير النظام. لا تمثل المشاريع الواردة فيها مكونات يجب جمعها، ولا تعني أن وجود ميزة فيها يثبت حاجة السوق. المرجع الأعلى دائمًا هو Problem Statement وخريطة الحقيقة وسجل الفرضيات.
...
| نطاق المصدر | طعام، حرفة، خدمة، محاسبة، SaaS، local-first، تدريب |
...
التدريب الأفضل هنا ليس LMS؛ بل checklist ينجز أول قيمة، مع شرح «لماذا؟» بجانب الحقل، ثم نتيجة وفعل تالٍ. Usertour مرجع للنمط، لا مكوّن يجب إدخاله كاملًا.
