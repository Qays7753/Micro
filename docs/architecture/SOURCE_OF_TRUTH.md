...
|---|---|---|---|
| Approved palette (18 values + disclosed derivatives) | `Documents/main micro-standard-v2/design-tokens.css` | `styles/vf-tokens.css` (the only bridge) | pages, components, index.css |
...
| Dark Mode boundary | `DARK_MODE_BOUNDARY.md` (run folder) + ADR-007 | future dark wave | ad-hoc dark styles |
