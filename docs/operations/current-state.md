...
|---|---|
| `main` | يحتوي الحزمة المالية عبر PR #115، وإصلاحات First-use عبر #118، وG18 عبر #119، وB-02 عبر #120، وبطاقات مراجعة النظام عبر #121، وعقود E-00 عبر #124، وG19 عبر #122. جميعها مراجع دمج تاريخية؛ رأس `main` الحالي يتحقق دائمًا عبر `git fetch origin --prune`. |
...
| برامج UX السابقة | برنامج إصلاح القرار البصري V1–V6 وتصحيحه مدمج على `main` عبر PR #96. وإصلاحات First-use مدمجة عبر #118، ثم G18 للمسارات العميقة والتاريخ عبر #119، ثم G19 لوضوح الاتفاق وحقيقة التكلفة الناقصة عبر #122؛ لا تغير هذه الشرائح معنى المال أو Schema أو Export/Import. |
...
G19 مدمجة؛ شرائح UX التالية G20 ثم G21 ثم G22 ثم G23 تبقى سلسلة مستقلة عن التوسعة. قبل فتح G20، افحص GitHub والرأس الحي وأنشئ فرعًا جديدًا من `origin/main`؛ لا يثبت هذا السجل أن PR محلية أو غير مرفوعة اندمجت. تظل اختبارات الجهاز الفعلي وPWA وOffline الإنتاجي وPilot البشري حدود قبول مستقلة.
...
| الحالة التالية | G19 مقبولة وظيفيًا ضمن نطاقها ومندمجة؛ لا يبدأ G20 إلا على فرع جديد من رأس `origin/main` وبعد قراءة خريطة UX والعقود والحالة الحية. |
