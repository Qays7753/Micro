...
>
> **حالة الدمج الحالية:** PWA مدمجة على `main` عبر PR #54، وG5 مدمجة عبر PR #53، وG6-A مدمجة عبر PR #57. لا توجد شريحة وظيفية مفتوحة الآن؛ `main` هو مرجع القدرات المدمجة.
...
**لا تبدأ أي مجموعة أو قدرة مالية/بنية جديدة الآن.** اكتملت G4-B وG5 وG6-A، وأضيفت PWA التشغيلية المصرح بها كطبقة نشر ثابتة فقط. لا توسع G6-A إلى التكرار أو الإشعارات أو التقويم الخارجي أو الحجز أو الموارد أو قدرة جديدة. لا تنتقل إلى POS أو مزامنة أو Auth أو أي معنى سحابي قبل طلب صريح جديد من مالك المنتج. لا توسّع الوقت الفعلي إلى أجر أو تكلفة أو توصية سعر، ولا توسّع G5 إلى صافي ربح نهائي أو COGS فعلي أو تنبؤ/توصية من دون عقد مستقل.
...
عند إغلاق/دمج شريحة جديدة، يعدل الوكيل هذا الملف في نفس PR ليحدث: commit/PR، جدول «ما هو منفذ»، جدول «الحالة المتوقفة عمدًا»، إصدارات schema/export إن تغيرت، ومسار القراءة التالي. PWA مدمجة على `main` عبر PR #54 وG5 عبر PR #53 وG6-A عبر PR #57؛ ويظل اختبار iOS الفعلي مطلوبًا قبل إعلان قبول PWA الإنتاجي متعدد المنصات. ثم يحدث `todo.md` فقط بما يطابق الواقع المندمج.
