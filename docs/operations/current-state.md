...
|---|---|
| `main` | يحتوي الحزمة المالية عبر PR #115 التجميعية عند `60b642ea2d9d30b63fdb1634268b8ad809a97ac1`؛ هذا مرجع دمج تاريخي، أما رأس `main` الحالي فيتحقق دائمًا عبر `git fetch origin --prune`. |
