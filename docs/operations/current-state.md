...
>
> **حالة الدمج الحالية:** PWA مدمجة على `main` عبر PR #54، وG5 مدمجة على `main` عبر PR #53. لا توجد شريحة وظيفية مفتوحة الآن.
...
عند دمج شريحة جديدة، يعدل الوكيل هذا الملف في نفس PR ليحدث: commit/PR، جدول «ما هو منفذ»، جدول «الحالة المتوقفة عمدًا»، إصدارات schema/export إن تغيرت، ومسار القراءة التالي. PWA مدمجة على `main` عبر PR #54 وG5 مدمجة عبر PR #53؛ ويظل الاختبار الفعلي على Android/iOS وCloudflare Pages قبل إعلان قبول الإنتاج. ثم يحدث `todo.md` فقط بما يطابق الواقع المندمج.
