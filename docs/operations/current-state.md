...
|---|---|
| `main` | يحتوي الحزمة المالية عبر PR #115، وإصلاحات First-use عبر #118، وG18 عبر #119، وB-02 عبر #120، وبطاقات مراجعة النظام عبر #121، وعقود E-00 عبر #124، وG19 عبر #122، وG20 عبر #128. جميعها مراجع دمج تاريخية؛ رأس `main` الحالي يتحقق دائمًا عبر `git fetch origin --prune`. |
...
G20 مدمجة عبر PR #128 عند رأس `origin/main` الحالي؛ بدأت G21 الآن كسلسلة UX مستقلة عن التوسعة على فرع جديد من رأس `origin/main` الحي. تبقى G22 ثم G23 غير مبدوءتين حتى قبول ودمج G21 مستقلًا. تظل اختبارات الجهاز الفعلي وPWA وOffline الإنتاجي وPilot البشري حدود قبول مستقلة.
...
| الاعتمادية | G20 مقبولة ومدمجة عبر PR #128؛ G22 قيد التنفيذ، وG23 متوقفة حتى إغلاق G22. |
...
## 12. G22 — Focused forms and Arabic polish قيد التنفيذ
بدأت G22 من رأس `origin/main` عند `feacce97dc43d77beaeac922c60c1f446dd96d68` على الفرع المستقل `agent-ux/g22-focused-forms` بعد rebase آمن فوق إضافات E-00 التوثيقية فقط. سؤال القرار هو: هل يستطيع المالك حفظ واقعة مصروف أو إعلان G5 بالحقول الأساسية أولًا، ثم فتح السياق والمعرفة والربط والملاحظة عند الحاجة، مع بقاء العملة والتاريخ والجمع العربي مقروءًا دون تغيير المعنى المالي؟ النطاق محصور في M-20 إلى M-22: نموذج المصروف يبرز المبلغ والتاريخ والجهة وما حدث، مع حصة المشروع/المعرفة إلزامية للمشترك؛ G5 يبرز النوع والمبلغ والتاريخ والمصدر، ثم يضع تفاصيل الإعلان والربط والملاحظة في طبقة ثانوية؛ وتُراجع formatters للمال والتاريخ والجمع الطويل دون تغيير التخزين أو العقود. لا إسقاط لحقول المعرفة أو الحصة المشتركة أو مصدر الإعلان، ولا تغيير في Domain أو العقود المالية أو semantics في Application؛ اقتصر استخدام Application على صياغة نص عرضي عبر formatter، بلا تغيير في الحساب أو التخزين. لا تغيير في schema/export أو Market/Delivery/Auth/Cloud.
| الحقل | الحقيقة الحالية |
|---|---|
| الحالة | قيد التنفيذ؛ لم تُفتح PR ولم يحدث دمج. |
| الفرع والرأس | `agent-ux/g22-focused-forms` من `origin/main` عند `feacce9` بعد rebase فوق تغييرات E-00 التوثيقية فقط. |
| الاعتمادية | G21 مقبولة ومدمجة عبر PR #129؛ G23 متوقفة حتى إغلاق G22. |
| القبول المقرر | المصروف وG5 يبدآن بالحقول الأساسية، التفاصيل موجودة ومشروطة، الملاحظة الإلزامية تفتح سياقها عند الحاجة، لا `JOD minor` للمستخدم، والتاريخ/العملة/الجمع العربي واضح مع أرقام ASCII/LTR. |
| حدود QA | بيانات اصطناعية ومحلية فقط؛ يجب توثيق فصل الإعلان عن الكاش وعدم ادعاء جهاز حقيقي أو Production أو Pilot. |
## References
