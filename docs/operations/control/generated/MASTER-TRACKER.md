...
BLOCKED: 3 · IN_REVIEW: 2 · READY: 15 · BACKLOG: 2 · REVIEW_REQUIRED: 7 · DEFERRED: 25 · VERIFIED: 10
...
| CTRL-001 | IN_REVIEW | GOVERNANCE | NOT_APPLICABLE | P1 | stage-0 | اعتماد Operations Control v2 | Product owner / Manus coordination | governance, documentation | — |
| CTRL-002 | IN_REVIEW | GOVERNANCE | EVIDENCE_RECONCILIATION_REQUIRED | P1 | stage-0 | مصالحة القدرات والتقارير ومصادر الحقيقة | Product owner / Manus coordination | governance, documentation | — |
...
| OPS-001 | READY | FIX_BEFORE_PILOT | NOT_APPLICABLE | P1 | stage-2 | المواعيد والاستحقاقات وتقادم الذمم الأساسي | Product owner / Manus coordination | Layer 2, application, presentation | CTRL-001 |
| OPS-005 | READY | FIX_BEFORE_PILOT | NOT_APPLICABLE | P1 | stage-2 | سطح قادم موحد للدفعات والتحصيلات والطلبات والالتزامات | Product owner / Manus coordination | Layer 2, application, presentation | CTRL-001, OPS-001 |
...
| OPS-004 | READY | FIX_BEFORE_PILOT | NOT_APPLICABLE | P2 | stage-2 | ربط القوالب بالتكلفة المخططة دون استهلاك فعلي | Product owner / Manus coordination | Layer 2, application, presentation | CTRL-001 |
| OPS-006 | READY | FIX_BEFORE_PILOT | NOT_APPLICABLE | P2 | stage-2 | تقادم ديون مبسط قبل الشرائح المتقدمة | Product owner / Manus coordination | Layer 2, application, presentation | CTRL-001, OPS-001 |
...
| G-001 | REVIEW_REQUIRED | FIX_BEFORE_PILOT | NOT_APPLICABLE | P1 | audit-2026-09-19 | فخ الاستهلاك المزدوج عند التسليم | Product owner / Manus coordination | cross-layer | — |
...
| G-002 | REVIEW_REQUIRED | FIX_BEFORE_PILOT | NOT_APPLICABLE | P2 | audit-2026-09-19 | ذرية تخصيص دفعة المورد للمحفظة | Product owner / Manus coordination | cross-layer | — |
| G-003 | REVIEW_REQUIRED | FIX_BEFORE_PILOT | NOT_APPLICABLE | P2 | audit-2026-09-19 | حرس القراءة القديمة عند حفظ الطلب | Product owner / Manus coordination | cross-layer | — |
...
| G-006 | REVIEW_REQUIRED | FIX_BEFORE_PILOT | NOT_APPLICABLE | P3 | audit-2026-09-19 | توحيد حرس السحب بين مساري مال المالك | Product owner / Manus coordination | cross-layer | — |
