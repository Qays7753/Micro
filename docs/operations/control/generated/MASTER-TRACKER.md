...
BLOCKED: 3 · IN_PROGRESS: 1 · READY: 14 · BACKLOG: 2 · REVIEW_REQUIRED: 1 · DEFERRED: 25 · VERIFIED: 18
...
| OPS-001 | IN_PROGRESS | FIX_BEFORE_PILOT | NOT_APPLICABLE | P1 | stage-2 | المواعيد والاستحقاقات وتقادم الذمم الأساسي | Product owner / Manus coordination | Layer 2, application, presentation | CTRL-001 |
