...
BLOCKED: 3 · IN_REVIEW: 2 · READY: 12 · BACKLOG: 2 · REVIEW_REQUIRED: 1 · DEFERRED: 25 · VERIFIED: 19
...
| OPS-005 | IN_REVIEW | FIX_BEFORE_PILOT | NOT_APPLICABLE | P1 | stage-2 | سطح قادم موحد للدفعات والتحصيلات والطلبات والالتزامات | Product owner / Manus coordination | Layer 2, application, presentation | CTRL-001, OPS-001 |
| OPS-006 | IN_REVIEW | FIX_BEFORE_PILOT | NOT_APPLICABLE | P2 | stage-2 | تقادم ديون مبسط قبل الشرائح المتقدمة | Product owner / Manus coordination | Layer 2, application, presentation | CTRL-001, OPS-001 |
