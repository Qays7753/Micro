...
BLOCKED: 3 · IN_REVIEW: 2 · READY: 9 · BACKLOG: 2 · REVIEW_REQUIRED: 1 · DEFERRED: 25 · VERIFIED: 22
...
| OPS-009 | IN_REVIEW | FIX_BEFORE_PILOT | NOT_APPLICABLE | P1 | stage-2 | حماية Cost Snapshot وإعلان النتيجة النهائية أو التقديرية | Product owner / Manus coordination | Layer 2, application, presentation | CTRL-001, OPS-007 |
| OPS-007 | IN_REVIEW | FIX_BEFORE_PILOT | NOT_APPLICABLE | P2 | stage-2 | مقارنة التكلفة المخططة بالمستهلكة والفرق | Product owner / Manus coordination | Layer 2, application, presentation | CTRL-001, OPS-004 |
