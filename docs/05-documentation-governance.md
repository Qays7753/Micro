...
| 17 | `docs/implementation/03-pre-build-alignment-v1.md` | CURRENT / GATE | تعريف Prototype وMVP ومحاكاة ما قبل البناء |
...
| Prototype الهاتف | بوابة Pre-build + خارطة التنفيذ + العقود | النموذج التشغيلي وسياسة التوجيه ومصفوفة السيناريوهات |
