...
| `network_attention` | source، subject ref، state، next action، updated at، recipient ref. | interaction scoped. | مبلغ، هاتف، محتوى كامل، score أو urgency مصطنع أو صندوق خدمات مركزي. |
