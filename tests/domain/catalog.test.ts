...
describe("catalog domain core", () => {
  ...
  it("rejects a catalog reference with blank identity or unsupported type instead of inventing a product", () => {
    expect(() => createCatalogItem({ id: "", kind: "product", name: "صندوق", unitLabel: null, createdAt: "2026-08-23T10:00:00.000Z", createdOperationKey: "key" })).toThrow("معرف المرجع");
    expect(() => createCatalogItem({ id: "bad-kind", kind: "other" as never, name: "صندوق", unitLabel: null, createdAt: "2026-08-23T10:00:00.000Z", createdOperationKey: "key" })).toThrow("نوع المرجع");
    expect(() => createCatalogItem({ id: "blank-name", kind: "product", name: " ", unitLabel: null, createdAt: "2026-08-23T10:00:00.000Z", createdOperationKey: "key" })).toThrow("اسم المرجع");
  });
});
