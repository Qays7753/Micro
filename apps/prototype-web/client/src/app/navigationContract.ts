...
export const canonicalReturnFallbacks: Readonly<Record<string, string>> = {
  ...
  /* المجموعة ٥ (عقد ٣٠): القارئ الكامل للنشاط — بيته مالي؛ يُفتح من الرئيسية
   * («افتح السجل الكامل») ومن مالي؛ البديل القانوني مالي. */
  "/finance/activity": "/finance",
  /* المجموعة ٥ (عقد ٣٣): معاينة المشاركة — بديلها القانوني مصدر الاستدعاء. */
  "/share/preview": "/finance",
  ...
  /* Wave 4.2 — P-4.2-4 (F05): المدخل المرئي لفحص السلامة صار «المالية ←
   * المزيد ← سلامة الحسابات» — المسار التقني /tools/integrity يبقى للتوافق،
   * وبديله الكنوني انتقل إلى سطح «المزيد» (تحديث موثق واحد مع عقد ٢٦ §2.2). */
  "/tools/integrity": "/finance/more",
  /* F01: سطح «المزيد من المالية» — بديله الكنوني المستوى الأول للمالية. */
  "/finance/more": "/finance",
  /* F04 (قرار المالك — Wave 4.2): البديل الكنوني للكتالوج صار الرئيسية —
   * بيت قسم «منتجاتي وخدماتي» المعلن بعد تنظيف أدواتي (تحديث موثق واحد مع
   * عقد ٢٦ §2.2 واختباره). */
  "/catalog": "/",
};
