...
const deepFlowPatterns: readonly RegExp[] = [
  ...
  /^\/orders\/[^/]+\/deliver$/,
  /* المجموعة ٤ (عقد ٢٩): محرر الأصل وتفصيله عمقان — القارئ/القائمة سطح يبقي
   * التنقل مثل الأدوات؛ المحرر يخفيه ويحرس المدخلات غير المحفوظة. */
  /^\/assets\/new$/,
  /^\/assets\/[^/]+$/,
  /* المجموعة ٤ (عقد ٢٩): محرر القرض وتفصيله عمقان — القائمة سطح، والباقي عمق. */
  /^\/loans\/new$/,
  /^\/loans\/[^/]+$/,
  /* FIN-001 (WS-178 — Wave 6): محرر القرض المستلم وتفصيله عمقان كإخوتهما
   * الصادرة — اختيار النوع الاقتصادي الصريح فعل مالي واعٍ يحرس المدخلات. */
  /^\/loans\/received\/new$/,
  /^\/loans\/received\/[^/]+$/,
