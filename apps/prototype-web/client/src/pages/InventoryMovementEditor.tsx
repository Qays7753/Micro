        ...
        <p>
          {safeType === "receipt"
            ...
            : safeType === "consume"
              ...
              : safeType === "adjust"
                ? "ضبط الجرد قرار مالك موثق بسبب إلزامي — يصحح الكمية بلا حذف حركة، مفصول عن الهدر اسمًا وسببًا وأثرًا."
        ...
        <div>
          ...
          <strong>
            {safeType === "consume"
              ...
              : safeType === "adjust"
                ? "الضبط ليس هدرًا — تصحيح جرد بمعنى محايد لا يُسجَّل خسارة."
