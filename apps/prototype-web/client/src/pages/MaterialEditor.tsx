/** Style: Micro decision path — opening a material records known stock, not a retroactive expense. */
...
export default function MaterialEditor() {
  ...
  async function save(): Promise<boolean> {
    ...
    const result = await inventory.openMaterial({
      name,
      unit,
      openingQuantityMilli: quantityMilli,
      openingValueMinor: valueMinor,
      occurredOn: date,
      note,
  ...
  return (
    <section className="micro-page micro-finance-page">
      ...
      <div className="micro-page-heading">
        ...
        <h1>ما المادة المتوفرة الآن؟</h1>
        <p>سجّل وحدة ثابتة وكمية وقيمة تعرفهما. هذا مخزون متاح، وليس مصروف بيع.</p>
      </div>
      <section className="micro-decision-card">
        ...
        <div>
          ...
          <p>يمكن ترك الكمية والقيمة صفرًا لتعريف المادة قبل استلام شراء لاحق.</p>
        </div>
      </section>
