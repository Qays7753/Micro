    ...
    <section className="micro-page micro-market-page" data-testid="market-soon-page">
      ...
      <section className="micro-soon-card" data-testid="market-soon-card">
        ...
        <div>
          ...
          <p>
            سيجمع السوق مستقبليًا موردين ومواد بأسعار معلنة، فتطلب جاهزيّتك من التطبيق مباشرة بدل
            التنقل والسؤال اليدوي.
          </p>
          <p>
            هذه النسخة نسخة محلية تعمل على جهازك: تسجيلك للموردين والمشتريات متاح الآن من
            «المالية» و«العمل»، والسوق نفسه غير مشغّل بعد — لا موردين معروضين ولا طلبات شراء من هنا.
          </p>
        </div>
      </section>
