      ...
      <div className="micro-page-heading micro-setup-heading">
        ...
        {step === 1 ? (
          <div className="micro-setup-intro" data-testid="setup-value-statement">
            ...
            <p>
              سجلات مشروعك محفوظة على هذا الجهاز فقط في هذه النسخة — لا مزامنة سحابية ولا دخول من جهاز
              آخر، ومسح بيانات المتصفح قد يمسحها؛ صدّر نسخة من الإعدادات لاحقًا للاحتياط.
            </p>
          </div>
        ) : null}
