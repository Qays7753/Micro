...
describe("party ledger supplier payments survive a documented payment reversal", () => {
  it("does not show paid-after-initial after the later payment was reversed", async () => {
    ...
    const saved = await store.saveSupplierPurchase({
      ...
      payments: [
        {
          id: "purchase-pl-1:initial",
          amountMinor: 2000,
          occurredOn: "2026-09-02",
          recordedAt: "2026-09-02T09:00:00.000Z",
          idempotencyKey: "pl-init",
          note: "دفعة أولى",
        },
        {
          id: "purchase-pl-1:pay-1",
          amountMinor: 1000,
          occurredOn: "2026-09-03",
          recordedAt: "2026-09-03T09:00:00.000Z",
          idempotencyKey: "pl-pay-1",
          note: "دفعة ثانية",
        },
      ],
      paymentReversals: [
        {
          id: "purchase-pl-1:rev-1",
          paymentId: "purchase-pl-1:pay-1",
          amountMinor: 1000,
          reason: "خطأ مزدوج",
          occurredOn: "2026-09-03",
          recordedAt: "2026-09-03T10:00:00.000Z",
          idempotencyKey: "pl-rev-1",
        },
      ],
      revisions: [],
