...
export type DraftInput = Pick<OrderDraft, "intent" | "customerName" | "itemName" | "catalogItemId" | "specifications" | "quantity" | "costSnapshots" | "activeCostSnapshotId" | "linkedOrderId">;
...
export class DraftService {
  ...
  async create(intent: DraftIntent): Promise<DraftSaveResult> { return this.save({ id: createId(), intent, customerName: "", itemName: "", catalogItemId: null, specifications: "", quantity: 1, costSnapshots: [], activeCostSnapshotId: null, linkedOrderId: null, createdAt: this.now() }); }
