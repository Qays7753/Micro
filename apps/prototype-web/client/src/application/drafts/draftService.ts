...
export type DraftInput = Pick<OrderDraft, "intent" | "customerName" | "itemName" | "specifications" | "quantity" | "costSnapshots" | "activeCostSnapshotId">;
...
export class DraftService {
  ...
  async create(intent: DraftIntent): Promise<DraftSaveResult> { return this.save({ id: createId(), intent, customerName: "", itemName: "", specifications: "", quantity: 1, costSnapshots: [], activeCostSnapshotId: null, createdAt: this.now() }); }
