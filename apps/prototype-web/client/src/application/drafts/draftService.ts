...
export type DraftInput = Pick<OrderDraft, "intent" | "customerName" | "itemName" | "specifications" | "quantity">;
...
export class DraftService {
  ...
  async create(intent: DraftIntent): Promise<DraftSaveResult> { return this.save({ id: createId(), intent, customerName: "", itemName: "", specifications: "", quantity: 1, createdAt: this.now() }); }
