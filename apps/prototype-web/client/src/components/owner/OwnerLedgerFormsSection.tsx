    ...
    <>
      ...
      <details className="micro-owner-layer">
        ...
        <section className="micro-form-card">
          ...
          <p>
            السحب الشخصي العادي له مدخل واحد من «المالية» — «سجّل سحبًا شخصيًا». ما هنا مرتبط بسجلات الدفتر:
            تسوية حق أو رصيد محدد، إرجاع سحب سابق، أو حقن رأس مال جديد. كل حركة تحتاج محفظة وسببًا وملاحظة،
            والسحب ليس مصروف تشغيل، والإرجاع كرأس مال جديد لا يسوي الحق.
          </p>
          <div className="micro-field-grid">
            <label className="micro-field">
