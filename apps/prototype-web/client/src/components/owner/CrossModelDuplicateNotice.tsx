  ...
  return (
    <section className="micro-decision-card" data-owner-duplicate-guard={duplicate.direction} role="alert">
      ...
      <div>
        ...
        <p>
          سجل «مال المالك» يقرأ من مصدرين تاريخيين (حدث مالي عام وحركة دفتر)، وتسجيل العملية نفسها فيهما معًا
          يضاعف أثرها بصمت. راجع الدفتر الموحد أولًا؛ وإن كانت هذه عملية جديدة مختلفة فعلًا فأكّد للمتابعة.
        </p>
        <p>
          <bdi dir="ltr">
