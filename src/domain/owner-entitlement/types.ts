...
export type CreateOwnerEntitlementPolicyInput = Omit<
  OwnerEntitlementPolicy,
  "createdAt" | "seriesId" | "successorOfPolicyId"
> & {
  createdAt: string;
...
export type OwnerEntitlementPolicyTerms = Pick<
  OwnerEntitlementPolicy,
  "kind" | "amountMinor" | "percentageBps" | "unitLabel" | "endsOn"
>;

export type CreateOwnerEntitlementPolicySuccessorInput = Omit<
  OwnerEntitlementPolicy,
  "family" | "createdAt"
> & {
  createdAt: string;
