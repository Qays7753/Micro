...
export type InventoryMovement = { id: string; materialId: string; type: InventoryMovementType; occurredOn: string; recordedAt: string; quantityDeltaMilli: number; valueDeltaMinor: number; note: string; reason: string | null; operationKey: string; purchaseId: string | null; orderId: string | null; reversesMovementId: string | null; wasteContext: WasteContext | null };
export type CreateMaterialInput = { id: string; name: string; unit: MaterialUnit; createdAt: string; createdOperationKey: string };
export type CreateInventoryMovementInput = Omit<InventoryMovement, "reason" | "purchaseId" | "orderId" | "reversesMovementId" | "wasteContext"> & { reason?: string | null; purchaseId?: string | null; orderId?: string | null; reversesMovementId?: string | null; wasteContext?: WasteContext | null };
