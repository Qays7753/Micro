 ...
 * (إصلاح تكاملي — مجموعة ٤): المتبقي الذي يفتحه تصحيح السعر على طلب مُغلق
 * (كما يفتحه التراجع عن قبضة) دينٌ مسجل قابل للتحصيل من كل المداخل — حالة
 * «partially_paid» على طلب مغلق كانت عمياء: لا الرئيسية ولا دفتر الناس ولا
 * ورقة التحصيل تعرضها فيصبح المبلغ بلا أي مدخل. */
